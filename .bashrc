...
# here's where i'm adding my own stuff!
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/hersh/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/hersh/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/hersh/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
